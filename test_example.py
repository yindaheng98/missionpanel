...
from missionpanel.example import TTRSSHubRootSubmitter, SubprocessParallelAsyncHandler
from missionpanel.orm import Mission, Attempt

logging.basicConfig(level=logging.INFO)


class FakeHandler(SubprocessParallelAsyncHandler):
...
async def main(session: AsyncSession):
    ...
    submitter = TTRSSHubRootSubmitter(session)
